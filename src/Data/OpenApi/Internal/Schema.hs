...
-- {"example":"2016-07-22","type":"string","format":"date"}
...
-- {"type":"array","items":{"$ref":"#/components/schemas/Day"}}
...
-- {"type":"array","items":{"example":"2016-07-22","format":"date","type":"string"}}
--
...
-- {"type":"string","maxLength":5,"minLength":5,"pattern":"hello","enum":["hello"]}
--
-- >>> BSL.putStrLn $ encode $ sketchStrictSchema (1, 2, 3)
-- {"type":"array","items":[{"maximum":1,"minimum":1,"multipleOf":1,"type":"number","enum":[1]},{"maximum":2,"minimum":2,"multipleOf":2,"type":"number","enum":[2]},{"maximum":3,"minimum":3,"multipleOf":3,"type":"number","enum":[3]}],"maxItems":3,"minItems":3,"uniqueItems":true,"enum":[[1,2,3]]}
--
-- >>> BSL.putStrLn $ encode $ sketchStrictSchema ("Jack", 25)
-- {"type":"array","items":[{"maxLength":4,"pattern":"Jack","minLength":4,"type":"string","enum":["Jack"]},{"maximum":25,"minimum":25,"multipleOf":25,"type":"number","enum":[25]}],"maxItems":2,"minItems":2,"uniqueItems":true,"enum":[["Jack",25]]}
--
-- >>> data Person = Person { name :: String, age :: Int } deriving (Generic)
-- >>> instance ToJSON Person
-- >>> BSL.putStrLn $ encode $ sketchStrictSchema (Person "Jack" 25)
-- {"required":["age","name"],"properties":{"age":{"type":"number","maximum":25,"minimum":25,"enum":[25],"multipleOf":25},"name":{"type":"string","maxLength":4,"minLength":4,"pattern":"Jack","enum":["Jack"]}},"maxProperties":2,"minProperties":2,"type":"object","enum":[{"age":25,"name":"Jack"}]}
